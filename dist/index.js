...
let BaseRoutesViewer = class extends BaseCon$1 {
  ...
  sortOrderChanged(_evt) {
    ...
    this.fixed_section_header_2.style.display = this.sort_order_picker.value === "grade" ? "none" : "flex";
    this.fixed_section_header.style.display = this.sort_order_picker.value === "grade" ? "none" : "flex";
    console.log(this.sort_order_picker.value);
  }
  onInputFocus() {
  }
  get allowEmptyQuery() {
